    ...
    <>
      ...
      >
        ...
        <ul
          ...
          max-sm:text-gray-600 max-sm:bg-gray-100 max-sm:mt-0 max-sm:fixed max-sm:top-0 max-sm:left-0 max-sm:right-0 max-sm:bottom-0 max-sm:flex-col max-sm:max-w-96 max-sm:justify-start max-sm:gap-4 max-sm:pt-16 max-sm:transition-all max-sm:${
        ...
        <div
          ...
          } fixed top-0 right-0 left-0 bottom-0 bg-black opacity-15`}
        ></div>
      </nav>
    </>
  );
